...
def sftpClient(
    ...
    print('本地配体列表文件:' + _ligandListFilePath)
    ...
    try:
        ...
        sshClient.exec_command('rm -rf ' + remoteServerTaskPath )
        sshClient.close()
        sftp.close()
...
if __name__ == '__main__':
    ...
    print('=' * 35)
    ligandListFilePath = '/home/b519/wq/rlg/ledock/ligands/0/1/ligands'
